    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Share your triggers and hangups so you can truly understand each other
        </p>
      </div>
      ...
      {!coupleId && (
        <div className="p-4 rounded-xl bg-accent/50 text-center">
          <p className="text-sm text-accent-foreground">
            Link with a partner first to use this feature together!
          </p>
        </div>
      )}
        ...
        <div className="space-y-3">
          <div className="p-4 rounded-xl bg-accent/30 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-1 max-w-sm mx-auto">
              ...
              that shape how you react in your relationship. Your partner will see your answers to build deeper understanding.
            </p>
          </div>
          ...
          <TabsContent value="mine" className="mt-4 space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <Button
                variant="outline"
                size="sm"
                onClick={() => {/* open form in edit mode */}}
                ...
                {!insights && (
                  <div className="p-6 rounded-xl bg-accent/30 text-center space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      ...
                      and where misunderstandings might arise.
                    </p>
                    <Button
                      size="sm"
